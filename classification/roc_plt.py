...
def main(args):
    ...
    with open("opt_oversample_auc_ap.txt","a") as file:
        file.write('\n')
    ...
    # print(sklearn.metrics.roc_auc_score(np.array(train_preds),np.array(train_actual)))
    # print("Validation AUROC")
    # print(sklearn.metrics.roc_auc_score(np.array(val_preds),np.array(val_actual)))
